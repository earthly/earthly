...
type GlobalConfig struct {
	...
	BuildkitURL              string   `yaml:"buildkit_url"               help:"The address of your buildkit, remote or local. Port is ignored in favor of buildkit_port and debugger_port."`
	BuildkitPort             int      `yaml:"buildkit_port"              help:"What port should earthly use to communicate. Relative to the buildkit host."`
	DebuggerPort             int      `yaml:"debugger_port"              help:"What port should the debugger (and other interactive sessions) use to communicate. Relative to the buildkit host"`
