...
### Added
- New Github Actions Workflow commands integration `--github-annotations` flag or GITHUB_ACTIONS=true env. See [#2189](https://github.com/earthly/earthly/issues/2189)
