...
### Added
- New Github Actions Workflow commands integration `--github-annotations` flag or GITHUB_ACTIONS=true env. See [#4047](https://github.com/earthly/earthly/pull/4047)
