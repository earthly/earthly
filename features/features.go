...
type Features struct {
	...
	UseExplicitGlobalArgFlag   bool `long:"use-explicit-global-arg-flag" description:"require base target args to have explicit settings to be considered global args"`
