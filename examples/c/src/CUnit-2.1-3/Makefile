...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/config.h.in mkinstalldirs $(srcdir)/Jamrules.in \
	$(srcdir)/CUnit.spec.in $(srcdir)/cunit.pc.in COPYING TODO \
...
VERSION_MAJOR = 2
VERSION_MINOR = 1
abs_builddir = /Users/aks/code/os/cunit/cunit
abs_srcdir = /Users/aks/code/os/cunit/cunit
abs_top_builddir = /Users/aks/code/os/cunit/cunit
abs_top_srcdir = /Users/aks/code/os/cunit/cunit
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
ZIP = zip
RPM = rpmbuild
PACKAGE_TMPSPEC = ./SPECS/CUnit-2.1-3.spec
SPECFILE = CUnit".spec"
CHANGELOG = "ChangeLog"
SOURCE_GZIP_FILE = CUnit-2.1-3.tar.gz
SOURCE_ZIP_FILE = CUnit-2.1-3.zip
SOURCE_TAR_FILE = CUnit-2.1-3.tar
...
RPM_ATHLON = ./RPMS/athlon/CUnit-2.1-3.athlon.rpm
RPM_I386 = ./RPMS/i386/CUnit-2.1-3.i386.rpm
RPM_I486 = ./RPMS/i486/CUnit-2.1-3.i486.rpm
RPM_I586 = ./RPMS/i586/CUnit-2.1-3.i586.rpm
RPM_I686 = ./RPMS/i686/CUnit-2.1-3.i686.rpm
RPM_K6 = ./RPMS/athlon/CUnit-2.1-3.k6.rpm
RPM_SRC = ./SRPMS/CUnit-2.1-3.src.rpm
...
zip: clean
	...
	${ZIP} -rT ${SOURCE_ZIP_FILE} CUnit-2.1-3/* ${ZIP_EXCLUDES} && \
	cp -f ${SOURCE_ZIP_FILE} ./CUnit-2.1-3/ && \
	cd CUnit-2.1-3
...
tarball: clean
	...
	tar cvf ${SOURCE_TAR_FILE} ${TAR_EXCLUDES} CUnit-2.1-3/* && \
	cp -f ${SOURCE_TAR_FILE} ./CUnit-2.1-3/  && \
	rm -f ${SOURCE_TAR_FILE} && \
	cd CUnit-2.1-3
