...
```bash
sudo /bin/sh -c 'wget https://github.com/earthly/earthly/releases/download/v0.4.2/earthly-linux-amd64 -O /usr/local/bin/earthly && chmod +x /usr/local/bin/earthly'
```
