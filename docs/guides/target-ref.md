...
* `+build`
* `./js+deps`
* `github.com/earthly/earthly:v0.7.21+earthly`
...
* `./js+build/dist`
* `github.com/earthly/earthly:v0.7.21+earthly/earthly`
...
* `+COMPILE`
* `./js+NPM_INSTALL`
* `github.com/earthly/earthly:v0.7.21+DOWNLOAD_DIND`
...
| `github.com/earthly/earthly:v0.7.21` | `github.com/earthly/earthly:v0.7.21+build` | `github.com/earthly/earthly:v0.7.21+build/out.bin` | `github.com/earthly/earthly:v0.7.21+COMPILE` |
...
| `IMPORT github.com/earthly/earthly:v0.7.21` | `earthly` | `earthly+build` | `earthly+build/out.bin` | `earthly+COMPILE` |
