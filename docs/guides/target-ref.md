...
* `+build`
* `./js+deps`
* `github.com/earthly/earthly:v0.8.2+earthly`
...
* `./js+build/dist`
* `github.com/earthly/earthly:v0.8.2+earthly/earthly`
...
* `+COMPILE`
* `./js+NPM_INSTALL`
* `github.com/earthly/earthly:v0.8.2+DOWNLOAD_DIND`
...
| `github.com/earthly/earthly:v0.8.2` | `github.com/earthly/earthly:v0.8.2+build` | `github.com/earthly/earthly:v0.8.2+build/out.bin` | `github.com/earthly/earthly:v0.8.2+COMPILE` |
...
| `IMPORT github.com/earthly/earthly:v0.8.2` | `earthly` | `earthly+build` | `earthly+build/out.bin` | `earthly+COMPILE` |
