...
* `+build`
* `./js+deps`
* `github.com/earthly/earthly:v0.7.19+earthly`
...
* `./js+build/dist`
* `github.com/earthly/earthly:v0.7.19+earthly/earthly`
...
* `+COMPILE`
* `./js+NPM_INSTALL`
* `github.com/earthly/earthly:v0.7.19+DOWNLOAD_DIND`
...
| `github.com/earthly/earthly:v0.7.19` | `github.com/earthly/earthly:v0.7.19+build` | `github.com/earthly/earthly:v0.7.19+build/out.bin` | `github.com/earthly/earthly:v0.7.19+COMPILE` |
...
| `IMPORT github.com/earthly/earthly:v0.7.19` | `earthly` | `earthly+build` | `earthly+build/out.bin` | `earthly+COMPILE` |
