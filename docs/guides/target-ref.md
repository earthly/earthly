...
* `+build`
* `./js+deps`
* `github.com/earthly/earthly:v0.8.8+earthly`
...
* `./js+build/dist`
* `github.com/earthly/earthly:v0.8.8+earthly/earthly`
...
* `+COMPILE`
* `./js+NPM_INSTALL`
* `github.com/earthly/earthly:v0.8.8+DOWNLOAD_DIND`
...
| `github.com/earthly/earthly:v0.8.8` | `github.com/earthly/earthly:v0.8.8+build` | `github.com/earthly/earthly:v0.8.8+build/out.bin` | `github.com/earthly/earthly:v0.8.8+COMPILE` |
...
| `IMPORT github.com/earthly/earthly:v0.8.8` | `earthly` | `earthly+build` | `earthly+build/out.bin` | `earthly+COMPILE` |
