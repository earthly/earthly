...
* `+build`
* `./js+deps`
* `github.com/earthly/earthly:v0.8.0+earthly`
* `my-import+build`
...
* `./js+build/dist`
* `github.com/earthly/earthly:v0.8.0+earthly/earthly`
...
* `+COMPILE`
* `./js+NPM_INSTALL`
* `github.com/earthly/earthly:v0.8.0+DOWNLOAD_DIND`
* `my-import+COMPILE`
...
| `github.com/earthly/earthly:v0.8.0` | `github.com/earthly/earthly:v0.8.0+build` | `github.com/earthly/earthly:v0.8.0+build/out.bin` | `github.com/earthly/earthly:v0.8.0+COMPILE` |
...
| `IMPORT github.com/earthly/earthly:v0.8.0` | `earthly` | `earthly+build` | `earthly+build/out.bin` | `earthly+COMPILE` |
