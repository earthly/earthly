...
* `+build`
* `./js+deps`
* `github.com/earthly/earthly:v0.8.16+earthly`
* `my-import+build`
...
* `./js+build/dist`
* `github.com/earthly/earthly:v0.8.16+earthly/earthly`
...
* `+COMPILE`
* `./js+NPM_INSTALL`
* `github.com/earthly/earthly:v0.8.16+DOWNLOAD_DIND`
* `my-import+COMPILE`
...
| `github.com/earthly/earthly:v0.8.16` | `github.com/earthly/earthly:v0.8.16+build` | `github.com/earthly/earthly:v0.8.16+build/out.bin` | `github.com/earthly/earthly:v0.8.16+COMPILE` |
...
| `IMPORT github.com/earthly/earthly:v0.8.16` | `earthly` | `earthly+build` | `earthly+build/out.bin` | `earthly+COMPILE` |
