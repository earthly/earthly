...
Earthly provides officially supported images such as `earthly/dind:alpine-3.18-docker-23.0.6-r4` and `earthly/dind:ubuntu-23.04` to be used together with `WITH DOCKER`.
{% endhint %}
