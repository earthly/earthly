...
require (
	...
	github.com/earthly/cloud-api v1.0.1-0.20240315213044-379195138915
...
replace (
	...
	github.com/moby/buildkit => github.com/earthly/buildkit v0.0.0-20240311170941-20d4e2ffaa09
